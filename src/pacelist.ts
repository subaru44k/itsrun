...
import PaceTablePhoneComponent from "./components/laptime/pacetable_phone.vue";
import PaceTablePcComponent from "./components/laptime/pacetable_pc.vue";
import LapTimeSelectorComponent from "./components/laptime/laptimeselector.vue";
